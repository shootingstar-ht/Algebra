...
import AlgebraPool from '@alkaswap/core/artifacts/contracts/AlgebraPool.sol/AlgebraPool.json'
import AlgebraFactoryJson from '@alkaswap/core/artifacts/contracts/AlgebraFactory.sol/AlgebraFactory.json'
import AlgebraPoolDeployerJson from '@alkaswap/core/artifacts/contracts/AlgebraPoolDeployer.sol/AlgebraPoolDeployer.json'
import NFTDescriptorJson from '@alkaswap/periphery/artifacts/contracts/libraries/NFTDescriptor.sol/NFTDescriptor.json'
import NonfungiblePositionManagerJson from '@alkaswap/periphery/artifacts/contracts/NonfungiblePositionManager.sol/NonfungiblePositionManager.json'
import NonfungibleTokenPositionDescriptor from '@alkaswap/periphery/artifacts/contracts/NonfungibleTokenPositionDescriptor.sol/NonfungibleTokenPositionDescriptor.json'
import SwapRouter from '@alkaswap/periphery/artifacts/contracts/SwapRouter.sol/SwapRouter.json'
import WNativeToken from './external/WNativeToken.json'
import { linkLibraries } from './linkLibraries'
import { ISwapRouter, IWNativeToken, NFTDescriptor } from '@alkaswap/periphery/typechain'
import {
