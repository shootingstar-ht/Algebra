...
import {
  ...
  TestERC20,
  IAlgebraFactory,
} from '@alkaswap/periphery/typechain'

import {
  abi as NFTD_ABI,
  bytecode as NFTD_BYTECODE,
} from '@alkaswap/periphery/artifacts/contracts/NonfungibleTokenPositionDescriptor.sol/NonfungibleTokenPositionDescriptor.json'
import {
  abi as NFT_ABI,
  bytecode as NFT_BYTECODE,
} from '@alkaswap/periphery/artifacts/contracts/NonfungiblePositionManager.sol/NonfungiblePositionManager.json'
